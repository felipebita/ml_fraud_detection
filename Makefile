...
quick-experiment:
	...
	python3 src/model/validation.py --experiment quick

gs-experiment:
	@echo "Running grid search experiment..."
	python3 src/model/validation.py --experiment grid

train:
	@echo "Training the final model..."
	python3 src/model/training.py
...
check-deps:
	...
	deptry . -o logs/deptry.log

test:
	@echo "Applying feature repository changes before testing..."
	@echo "Materializing test features (2 hours of data)..."
	feast --chdir feature_repo materialize 2024-01-01T01:00:00 2024-01-01T02:00:00
	@echo "Running tests..."
	pytest tests/ -v --cov=src --cov-report=html --cov-report=term-missing --log-file=logs/pytest.log --log-cli-level=WARNING
...
feature-repo-apply:
	...
	feast --chdir feature_repo apply
